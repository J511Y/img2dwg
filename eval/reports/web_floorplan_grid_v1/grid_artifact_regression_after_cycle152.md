...
- generated_at: `2026-03-20T07:58:34.945647+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0317, cur=0.0317, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8683, cur=0.8684, delta=0.0001; avg_line_count: prev=128.5, cur=128.75, delta=0.25
...
- `two_stage_baseline`: avg_line_count=128.75, avg_axis_aligned_ratio=0.0317, std_axis_aligned_ratio=0.0047, avg_axis_margin_to_grid_threshold=0.8684, avg_axis_margin_score=86.84, max_axis_aligned_ratio=0.0444, max_axis_margin_to_grid_threshold=0.8556, p95_axis_aligned_ratio=0.0444, p95_axis_margin_to_grid_threshold=0.8556, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=244.5, avg_unique_y_count=244.5
