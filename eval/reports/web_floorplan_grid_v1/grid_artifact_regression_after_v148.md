...
- generated_at: `2026-03-18T10:11:38.047870+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0322, cur=0.0321, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8678, cur=0.8679, delta=0.0001; avg_line_count: prev=126.5833, cur=127.0, delta=0.4167
...
- `two_stage_baseline`: avg_line_count=127.0, avg_axis_aligned_ratio=0.0321, std_axis_aligned_ratio=0.0047, avg_axis_margin_to_grid_threshold=0.8679, avg_axis_margin_score=86.79, max_axis_aligned_ratio=0.0444, max_axis_margin_to_grid_threshold=0.8556, p95_axis_aligned_ratio=0.0444, p95_axis_margin_to_grid_threshold=0.8556, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=241.0, avg_unique_y_count=241.0
