...
- generated_at: `2026-03-16T16:09:03.669811+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0376, cur=0.0376, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8624, cur=0.8624, delta=0.0; avg_line_count: prev=111.1667, cur=111.1667, delta=0.0
...
- `two_stage_baseline`: avg_line_count=111.1667, avg_axis_aligned_ratio=0.0376, std_axis_aligned_ratio=0.0076, avg_axis_margin_to_grid_threshold=0.8624, avg_axis_margin_score=86.24, max_axis_aligned_ratio=0.05, max_axis_margin_to_grid_threshold=0.85, p95_axis_aligned_ratio=0.05, p95_axis_margin_to_grid_threshold=0.85, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=209.3333, avg_unique_y_count=209.25
