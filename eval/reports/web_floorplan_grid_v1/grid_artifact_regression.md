...
- generated_at: `2026-03-18T07:11:45.195176+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0323, cur=0.0323, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8677, cur=0.8677, delta=0.0; avg_line_count: prev=126.0, cur=126.1667, delta=0.1667
...
- `two_stage_baseline`: avg_line_count=126.1667, avg_axis_aligned_ratio=0.0323, std_axis_aligned_ratio=0.0047, avg_axis_margin_to_grid_threshold=0.8677, avg_axis_margin_score=86.77, max_axis_aligned_ratio=0.0444, max_axis_margin_to_grid_threshold=0.8556, p95_axis_aligned_ratio=0.0444, p95_axis_margin_to_grid_threshold=0.8556, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=239.3333, avg_unique_y_count=239.3333
