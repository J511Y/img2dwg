...
- generated_at: `2026-03-15T15:08:25.888552+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.1538, cur=0.1538, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.7462, cur=0.7462, delta=0.0; avg_line_count: prev=26.0, cur=26.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.1818, cur=0.1667, delta=-0.0151; avg_axis_margin_to_grid_threshold: prev=0.7182, cur=0.7333, delta=0.0151; avg_line_count: prev=22.0, cur=24.0, delta=2.0
...
- `two_stage_baseline`: avg_line_count=24.0, avg_axis_aligned_ratio=0.1667, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.7333, avg_axis_margin_score=73.33, max_axis_aligned_ratio=0.1667, max_axis_margin_to_grid_threshold=0.7333, p95_axis_aligned_ratio=0.1667, p95_axis_margin_to_grid_threshold=0.7333, min_axis_aligned_ratio=0.1667, min_axis_margin_to_grid_threshold=0.7333, avg_unique_x_count=35.0, avg_unique_y_count=34.0
