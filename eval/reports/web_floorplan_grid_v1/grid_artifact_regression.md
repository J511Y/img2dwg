...
- generated_at: `2026-03-17T15:40:30.262324+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0341, cur=0.0337, delta=-0.0004; avg_axis_margin_to_grid_threshold: prev=0.8659, cur=0.8663, delta=0.0004; avg_line_count: prev=118.5, cur=119.6667, delta=1.1667
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0338, cur=0.0338, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8662, cur=0.8662, delta=0.0; avg_line_count: prev=121.0, cur=121.0, delta=0.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=119.6667, avg_axis_aligned_ratio=0.0337, std_axis_aligned_ratio=0.0031, avg_axis_margin_to_grid_threshold=0.8663, avg_axis_margin_score=86.63, max_axis_aligned_ratio=0.04, max_axis_margin_to_grid_threshold=0.86, p95_axis_aligned_ratio=0.04, p95_axis_margin_to_grid_threshold=0.86, min_axis_aligned_ratio=0.0282, min_axis_margin_to_grid_threshold=0.8718, avg_unique_x_count=226.3333, avg_unique_y_count=226.3333
...
- `two_stage_baseline`: avg_line_count=121.0, avg_axis_aligned_ratio=0.0338, std_axis_aligned_ratio=0.0051, avg_axis_margin_to_grid_threshold=0.8662, avg_axis_margin_score=86.62, max_axis_aligned_ratio=0.0455, max_axis_margin_to_grid_threshold=0.8545, p95_axis_aligned_ratio=0.0455, p95_axis_margin_to_grid_threshold=0.8545, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=229.0, avg_unique_y_count=229.0
