...
- generated_at: `2026-03-15T10:10:35.622224+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.4286, cur=0.3333, delta=-0.0953; avg_axis_margin_to_grid_threshold: prev=0.4714, cur=0.5667, delta=0.0953; avg_line_count: prev=14.0, cur=12.0, delta=-2.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.4286, cur=0.3333, delta=-0.0953; avg_axis_margin_to_grid_threshold: prev=0.4714, cur=0.5667, delta=0.0953; avg_line_count: prev=14.0, cur=12.0, delta=-2.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=12.0, avg_axis_aligned_ratio=0.3333, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.5667, avg_axis_margin_score=56.67, max_axis_aligned_ratio=0.3333, max_axis_margin_to_grid_threshold=0.5667, p95_axis_aligned_ratio=0.3333, p95_axis_margin_to_grid_threshold=0.5667, min_axis_aligned_ratio=0.3333, min_axis_margin_to_grid_threshold=0.5667, avg_unique_x_count=12.0, avg_unique_y_count=11.0
...
- `two_stage_baseline`: avg_line_count=12.0, avg_axis_aligned_ratio=0.3333, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.5667, avg_axis_margin_score=56.67, max_axis_aligned_ratio=0.3333, max_axis_margin_to_grid_threshold=0.5667, p95_axis_aligned_ratio=0.3333, p95_axis_margin_to_grid_threshold=0.5667, min_axis_aligned_ratio=0.3333, min_axis_margin_to_grid_threshold=0.5667, avg_unique_x_count=12.0, avg_unique_y_count=11.0
