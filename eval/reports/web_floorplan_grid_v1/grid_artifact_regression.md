...
- generated_at: `2026-03-17T09:37:55.157068+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0342, cur=0.0342, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8658, cur=0.8658, delta=0.0; avg_line_count: prev=118.0, cur=118.0, delta=0.0
...
- `consensus_qa`: avg_line_count=118.0, avg_axis_aligned_ratio=0.0342, std_axis_aligned_ratio=0.0033, avg_axis_margin_to_grid_threshold=0.8658, avg_axis_margin_score=86.58, max_axis_aligned_ratio=0.0408, max_axis_margin_to_grid_threshold=0.8592, p95_axis_aligned_ratio=0.0408, p95_axis_margin_to_grid_threshold=0.8592, min_axis_aligned_ratio=0.0282, min_axis_margin_to_grid_threshold=0.8718, avg_unique_x_count=223.0, avg_unique_y_count=223.0
