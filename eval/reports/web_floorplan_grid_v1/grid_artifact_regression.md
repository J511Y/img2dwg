...
- generated_at: `2026-03-17T07:40:56.445601+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0344, cur=0.0344, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8656, cur=0.8656, delta=0.0; avg_line_count: prev=117.5, cur=117.5, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0356, cur=0.0352, delta=-0.0004; avg_axis_margin_to_grid_threshold: prev=0.8644, cur=0.8648, delta=0.0004; avg_line_count: prev=115.8333, cur=116.8333, delta=1.0
...
- `two_stage_baseline`: avg_line_count=116.8333, avg_axis_aligned_ratio=0.0352, std_axis_aligned_ratio=0.0058, avg_axis_margin_to_grid_threshold=0.8648, avg_axis_margin_score=86.48, max_axis_aligned_ratio=0.0476, max_axis_margin_to_grid_threshold=0.8524, p95_axis_aligned_ratio=0.0476, p95_axis_margin_to_grid_threshold=0.8524, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=220.6667, avg_unique_y_count=220.6667
