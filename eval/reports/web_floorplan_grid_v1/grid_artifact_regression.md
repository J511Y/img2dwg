...
- generated_at: `2026-03-17T19:41:45.189982+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0338, cur=0.0341, delta=0.0003; avg_axis_margin_to_grid_threshold: prev=0.8662, cur=0.8659, delta=-0.0003; avg_line_count: prev=119.3333, cur=118.5, delta=-0.8333
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0336, cur=0.0336, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8664, cur=0.8664, delta=0.0; avg_line_count: prev=121.5, cur=121.5, delta=0.0
...
- `two_stage_baseline`: avg_line_count=121.5, avg_axis_aligned_ratio=0.0336, std_axis_aligned_ratio=0.0048, avg_axis_margin_to_grid_threshold=0.8664, avg_axis_margin_score=86.64, max_axis_aligned_ratio=0.0444, max_axis_margin_to_grid_threshold=0.8556, p95_axis_aligned_ratio=0.0444, p95_axis_margin_to_grid_threshold=0.8556, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=230.0, avg_unique_y_count=230.0
