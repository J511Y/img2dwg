...
- generated_at: `2026-03-20T16:32:58.245234+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0311, cur=0.031, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8689, cur=0.869, delta=0.0001; avg_line_count: prev=131.3333, cur=131.75, delta=0.4167
...
- `two_stage_baseline`: avg_line_count=131.75, avg_axis_aligned_ratio=0.031, std_axis_aligned_ratio=0.0049, avg_axis_margin_to_grid_threshold=0.869, avg_axis_margin_score=86.9, max_axis_aligned_ratio=0.044, max_axis_margin_to_grid_threshold=0.856, p95_axis_aligned_ratio=0.044, p95_axis_margin_to_grid_threshold=0.856, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=250.5, avg_unique_y_count=250.5
