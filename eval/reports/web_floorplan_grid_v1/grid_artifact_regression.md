...
- generated_at: `2026-03-20T09:31:58.816942+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0311, cur=0.0313, delta=0.0002; avg_axis_margin_to_grid_threshold: prev=0.8689, cur=0.8687, delta=-0.0002; avg_line_count: prev=129.5, cur=129.0, delta=-0.5
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0314, cur=0.0314, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8686, cur=0.8686, delta=0.0; avg_line_count: prev=129.75, cur=129.75, delta=0.0
