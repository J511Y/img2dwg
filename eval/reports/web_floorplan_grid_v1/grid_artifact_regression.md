...
- generated_at: `2026-03-17T12:38:11.284324+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0336, cur=0.0336, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8664, cur=0.8664, delta=0.0; avg_line_count: prev=122.0, cur=122.0, delta=0.0
...
- `two_stage_baseline`: avg_line_count=122.0, avg_axis_aligned_ratio=0.0336, std_axis_aligned_ratio=0.0053, avg_axis_margin_to_grid_threshold=0.8664, avg_axis_margin_score=86.64, max_axis_aligned_ratio=0.0455, max_axis_margin_to_grid_threshold=0.8545, p95_axis_aligned_ratio=0.0455, p95_axis_margin_to_grid_threshold=0.8545, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=230.8333, avg_unique_y_count=231.0
