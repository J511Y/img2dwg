...
- generated_at: `2026-03-13T18:39:57.780688+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0652, cur=0.06, delta=-0.0052; avg_axis_margin_to_grid_threshold: prev=0.8348, cur=0.84, delta=0.0052; avg_line_count: prev=92.0, cur=100.0, delta=8.0
...
- `two_stage_baseline`: avg_line_count=100.0, avg_axis_aligned_ratio=0.06, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.84, avg_axis_margin_score=84.0, max_axis_aligned_ratio=0.06, max_axis_margin_to_grid_threshold=0.84, p95_axis_aligned_ratio=0.06, p95_axis_margin_to_grid_threshold=0.84, min_axis_aligned_ratio=0.06, min_axis_margin_to_grid_threshold=0.84, avg_unique_x_count=182.0, avg_unique_y_count=172.0
