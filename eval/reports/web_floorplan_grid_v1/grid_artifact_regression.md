...
- generated_at: `2026-03-14T00:39:40.189319+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0652, cur=0.0652, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8348, cur=0.8348, delta=0.0; avg_line_count: prev=92.0, cur=92.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0638, cur=0.0577, delta=-0.0061; avg_axis_margin_to_grid_threshold: prev=0.8362, cur=0.8423, delta=0.0061; avg_line_count: prev=94.0, cur=104.0, delta=10.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=92.0, avg_axis_aligned_ratio=0.0652, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.8348, avg_axis_margin_score=83.48, max_axis_aligned_ratio=0.0652, max_axis_margin_to_grid_threshold=0.8348, p95_axis_aligned_ratio=0.0652, p95_axis_margin_to_grid_threshold=0.8348, min_axis_aligned_ratio=0.0652, min_axis_margin_to_grid_threshold=0.8348, avg_unique_x_count=151.0, avg_unique_y_count=156.0
...
- `two_stage_baseline`: avg_line_count=104.0, avg_axis_aligned_ratio=0.0577, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.8423, avg_axis_margin_score=84.23, max_axis_aligned_ratio=0.0577, max_axis_margin_to_grid_threshold=0.8423, p95_axis_aligned_ratio=0.0577, p95_axis_margin_to_grid_threshold=0.8423, min_axis_aligned_ratio=0.0577, min_axis_margin_to_grid_threshold=0.8423, avg_unique_x_count=190.6667, avg_unique_y_count=182.9167
