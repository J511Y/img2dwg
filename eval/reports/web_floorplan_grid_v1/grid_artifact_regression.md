...
- generated_at: `2026-03-13T11:08:58.977873+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.1304, cur=0.1304, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.7696, cur=0.7696, delta=0.0; avg_line_count: prev=46.0, cur=46.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.1304, cur=0.1111, delta=-0.0193; avg_axis_margin_to_grid_threshold: prev=0.7696, cur=0.7889, delta=0.0193; avg_line_count: prev=46.0, cur=54.0, delta=8.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=46.0, avg_axis_aligned_ratio=0.1304, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.7696, avg_axis_margin_score=76.96, max_axis_aligned_ratio=0.1304, max_axis_margin_to_grid_threshold=0.7696, p95_axis_aligned_ratio=0.1304, p95_axis_margin_to_grid_threshold=0.7696, min_axis_aligned_ratio=0.1304, min_axis_margin_to_grid_threshold=0.7696, avg_unique_x_count=59.0, avg_unique_y_count=64.0
...
- `two_stage_baseline`: avg_line_count=54.0, avg_axis_aligned_ratio=0.1111, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.7889, avg_axis_margin_score=78.89, max_axis_aligned_ratio=0.1111, max_axis_margin_to_grid_threshold=0.7889, p95_axis_aligned_ratio=0.1111, p95_axis_margin_to_grid_threshold=0.7889, min_axis_aligned_ratio=0.1111, min_axis_margin_to_grid_threshold=0.7889, avg_unique_x_count=90.8333, avg_unique_y_count=82.9167
