...
- generated_at: `2026-03-14T13:10:17.581974+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0058, cur=0.0056, delta=-0.0002; avg_axis_margin_to_grid_threshold: prev=0.8942, cur=0.8944, delta=0.0002; avg_line_count: prev=172.0, cur=180.0, delta=8.0
...
- `two_stage_baseline`: avg_line_count=180.0, avg_axis_aligned_ratio=0.0056, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.8944, avg_axis_margin_score=89.44, max_axis_aligned_ratio=0.0056, max_axis_margin_to_grid_threshold=0.8944, p95_axis_aligned_ratio=0.0056, p95_axis_margin_to_grid_threshold=0.8944, min_axis_aligned_ratio=0.0056, min_axis_margin_to_grid_threshold=0.8944, avg_unique_x_count=347.8333, avg_unique_y_count=338.9167
