...
- generated_at: `2026-03-16T09:39:05.679877+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0374, cur=0.0373, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8626, cur=0.8627, delta=0.0001; avg_line_count: prev=107.8333, cur=108.1667, delta=0.3334
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0421, cur=0.0412, delta=-0.0009; avg_axis_margin_to_grid_threshold: prev=0.8579, cur=0.8588, delta=0.0009; avg_line_count: prev=97.6667, cur=101.6667, delta=4.0
...
- `two_stage_baseline`: avg_line_count=101.6667, avg_axis_aligned_ratio=0.0412, std_axis_aligned_ratio=0.008, avg_axis_margin_to_grid_threshold=0.8588, avg_axis_margin_score=85.88, max_axis_aligned_ratio=0.0526, max_axis_margin_to_grid_threshold=0.8474, p95_axis_aligned_ratio=0.0526, p95_axis_margin_to_grid_threshold=0.8474, min_axis_aligned_ratio=0.025, min_axis_margin_to_grid_threshold=0.875, avg_unique_x_count=190.3333, avg_unique_y_count=190.3333
