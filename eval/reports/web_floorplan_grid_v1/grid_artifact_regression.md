...
- generated_at: `2026-03-15T10:40:43.595442+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.3333, cur=0.2857, delta=-0.0476; avg_axis_margin_to_grid_threshold: prev=0.5667, cur=0.6143, delta=0.0476; avg_line_count: prev=12.0, cur=14.0, delta=2.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.3333, cur=0.2857, delta=-0.0476; avg_axis_margin_to_grid_threshold: prev=0.5667, cur=0.6143, delta=0.0476; avg_line_count: prev=12.0, cur=14.0, delta=2.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=14.0, avg_axis_aligned_ratio=0.2857, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.6143, avg_axis_margin_score=61.43, max_axis_aligned_ratio=0.2857, max_axis_margin_to_grid_threshold=0.6143, p95_axis_aligned_ratio=0.2857, p95_axis_margin_to_grid_threshold=0.6143, min_axis_aligned_ratio=0.2857, min_axis_margin_to_grid_threshold=0.6143, avg_unique_x_count=16.0, avg_unique_y_count=14.0
