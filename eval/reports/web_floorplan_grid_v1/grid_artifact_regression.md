...
- generated_at: `2026-03-09T03:17:40.726824+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.2143, cur=0.2143, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.6857, cur=0.6857, delta=0.0; avg_line_count: prev=28.0, cur=28.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.2308, cur=0.2143, delta=-0.0165; avg_axis_margin_to_grid_threshold: prev=0.6692, cur=0.6857, delta=0.0165; avg_line_count: prev=26.0, cur=28.0, delta=2.0
