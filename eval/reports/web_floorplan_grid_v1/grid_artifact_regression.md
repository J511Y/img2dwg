...
- generated_at: `2026-03-15T08:39:49.309664+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.75, cur=0.6, delta=-0.15; avg_axis_margin_to_grid_threshold: prev=0.15, cur=0.3, delta=0.15; avg_line_count: prev=8.0, cur=10.0, delta=2.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.75, cur=0.6, delta=-0.15; avg_axis_margin_to_grid_threshold: prev=0.15, cur=0.3, delta=0.15; avg_line_count: prev=8.0, cur=10.0, delta=2.0
