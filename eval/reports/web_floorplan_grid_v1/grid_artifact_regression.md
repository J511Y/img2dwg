...
- generated_at: `2026-03-20T10:30:20.472004+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0322, cur=0.0319, delta=-0.0003; avg_axis_margin_to_grid_threshold: prev=0.8678, cur=0.8681, delta=0.0003; avg_line_count: prev=126.5833, cur=127.8333, delta=1.25
...
- `two_stage_baseline`: avg_line_count=127.8333, avg_axis_aligned_ratio=0.0319, std_axis_aligned_ratio=0.0047, avg_axis_margin_to_grid_threshold=0.8681, avg_axis_margin_score=86.81, max_axis_aligned_ratio=0.0444, max_axis_margin_to_grid_threshold=0.8556, p95_axis_aligned_ratio=0.0444, p95_axis_margin_to_grid_threshold=0.8556, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=242.6667, avg_unique_y_count=242.6667
