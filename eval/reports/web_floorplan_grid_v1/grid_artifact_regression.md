...
- generated_at: `2026-03-15T19:09:25.897572+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.1176, cur=0.1053, delta=-0.0123; avg_axis_margin_to_grid_threshold: prev=0.7824, cur=0.7947, delta=0.0123; avg_line_count: prev=34.0, cur=38.0, delta=4.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.1176, cur=0.1053, delta=-0.0123; avg_axis_margin_to_grid_threshold: prev=0.7824, cur=0.7947, delta=0.0123; avg_line_count: prev=34.0, cur=38.0, delta=4.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=38.0, avg_axis_aligned_ratio=0.1053, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.7947, avg_axis_margin_score=79.47, max_axis_aligned_ratio=0.1053, max_axis_margin_to_grid_threshold=0.7947, p95_axis_aligned_ratio=0.1053, p95_axis_margin_to_grid_threshold=0.7947, min_axis_aligned_ratio=0.1053, min_axis_margin_to_grid_threshold=0.7947, avg_unique_x_count=62.0, avg_unique_y_count=63.0
...
- `two_stage_baseline`: avg_line_count=38.0, avg_axis_aligned_ratio=0.1053, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.7947, avg_axis_margin_score=79.47, max_axis_aligned_ratio=0.1053, max_axis_margin_to_grid_threshold=0.7947, p95_axis_aligned_ratio=0.1053, p95_axis_margin_to_grid_threshold=0.7947, min_axis_aligned_ratio=0.1053, min_axis_margin_to_grid_threshold=0.7947, avg_unique_x_count=63.0, avg_unique_y_count=62.0
