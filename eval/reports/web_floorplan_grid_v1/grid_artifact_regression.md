...
- generated_at: `2026-03-14T00:09:02.029986+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0698, cur=0.0638, delta=-0.006; avg_axis_margin_to_grid_threshold: prev=0.8302, cur=0.8362, delta=0.006; avg_line_count: prev=86.0, cur=94.0, delta=8.0
...
- `two_stage_baseline`: avg_line_count=94.0, avg_axis_aligned_ratio=0.0638, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.8362, avg_axis_margin_score=83.62, max_axis_aligned_ratio=0.0638, max_axis_margin_to_grid_threshold=0.8362, p95_axis_aligned_ratio=0.0638, p95_axis_margin_to_grid_threshold=0.8362, min_axis_aligned_ratio=0.0638, min_axis_margin_to_grid_threshold=0.8362, avg_unique_x_count=170.6667, avg_unique_y_count=162.9167
