...
- generated_at: `2026-03-13T12:08:52.061722+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.1111, cur=0.0968, delta=-0.0143; avg_axis_margin_to_grid_threshold: prev=0.7889, cur=0.8032, delta=0.0143; avg_line_count: prev=54.0, cur=62.0, delta=8.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.1111, cur=0.1111, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.7889, cur=0.7889, delta=0.0; avg_line_count: prev=54.0, cur=54.0, delta=0.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=62.0, avg_axis_aligned_ratio=0.0968, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.8032, avg_axis_margin_score=80.32, max_axis_aligned_ratio=0.0968, max_axis_margin_to_grid_threshold=0.8032, p95_axis_aligned_ratio=0.0968, p95_axis_margin_to_grid_threshold=0.8032, min_axis_aligned_ratio=0.0968, min_axis_margin_to_grid_threshold=0.8032, avg_unique_x_count=91.0, avg_unique_y_count=96.0
