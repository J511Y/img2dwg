...
- generated_at: `2026-03-08T16:17:29.367872+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.4615, cur=0.4615, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.4385, cur=0.4385, delta=0.0; avg_line_count: prev=13.0, cur=13.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.4615, cur=0.4286, delta=-0.0329; avg_axis_margin_to_grid_threshold: prev=0.4385, cur=0.4714, delta=0.0329; avg_line_count: prev=13.0, cur=14.0, delta=1.0
