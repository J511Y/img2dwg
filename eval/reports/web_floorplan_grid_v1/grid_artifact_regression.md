...
- generated_at: `2026-03-13T13:08:47.386090+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0968, cur=0.0968, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8032, cur=0.8032, delta=0.0; avg_line_count: prev=62.0, cur=62.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.1, cur=0.0909, delta=-0.0091; avg_axis_margin_to_grid_threshold: prev=0.8, cur=0.8091, delta=0.0091; avg_line_count: prev=60.0, cur=66.0, delta=6.0
