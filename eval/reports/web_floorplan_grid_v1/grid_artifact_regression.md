...
- generated_at: `2026-03-08T09:17:34.835016+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=1.0, cur=1.0, delta=0.0; avg_axis_margin_to_grid_threshold: prev=-0.1, cur=-0.1, delta=0.0; avg_line_count: prev=6.0, cur=6.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=1.0, cur=0.8571, delta=-0.1429; avg_axis_margin_to_grid_threshold: prev=-0.1, cur=0.0429, delta=0.1429; avg_line_count: prev=6.0, cur=7.0, delta=1.0
