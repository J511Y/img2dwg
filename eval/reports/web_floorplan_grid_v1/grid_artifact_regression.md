...
- generated_at: `2026-03-08T10:47:30.074272+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.8571, cur=0.75, delta=-0.1071; avg_axis_margin_to_grid_threshold: prev=0.0429, cur=0.15, delta=0.1071; avg_line_count: prev=7.0, cur=8.0, delta=1.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.75, cur=0.75, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.15, cur=0.15, delta=0.0; avg_line_count: prev=8.0, cur=8.0, delta=0.0
