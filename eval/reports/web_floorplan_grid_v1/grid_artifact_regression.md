...
- generated_at: `2026-03-13T07:39:17.945984+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.1765, cur=0.15, delta=-0.0265; avg_axis_margin_to_grid_threshold: prev=0.7235, cur=0.75, delta=0.0265; avg_line_count: prev=34.0, cur=40.0, delta=6.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.1765, cur=0.1765, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.7235, cur=0.7235, delta=0.0; avg_line_count: prev=34.0, cur=34.0, delta=0.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=40.0, avg_axis_aligned_ratio=0.15, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.75, avg_axis_margin_score=75.0, max_axis_aligned_ratio=0.15, max_axis_margin_to_grid_threshold=0.75, p95_axis_aligned_ratio=0.15, p95_axis_margin_to_grid_threshold=0.75, min_axis_aligned_ratio=0.15, min_axis_margin_to_grid_threshold=0.75, avg_unique_x_count=54.0, avg_unique_y_count=54.0
...
- `two_stage_baseline`: avg_line_count=34.0, avg_axis_aligned_ratio=0.1765, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.7235, avg_axis_margin_score=72.35, max_axis_aligned_ratio=0.1765, max_axis_margin_to_grid_threshold=0.7235, p95_axis_aligned_ratio=0.1765, p95_axis_margin_to_grid_threshold=0.7235, min_axis_aligned_ratio=0.1765, min_axis_margin_to_grid_threshold=0.7235, avg_unique_x_count=51.0, avg_unique_y_count=43.0
