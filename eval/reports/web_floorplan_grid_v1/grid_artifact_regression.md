...
- generated_at: `2026-03-18T00:40:19.000704+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0318, cur=0.0317, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8682, cur=0.8683, delta=0.0001; avg_line_count: prev=126.8333, cur=127.1667, delta=0.3334
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0331, cur=0.0331, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8669, cur=0.8669, delta=0.0; avg_line_count: prev=123.3333, cur=123.3333, delta=0.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=127.1667, avg_axis_aligned_ratio=0.0317, std_axis_aligned_ratio=0.0027, avg_axis_margin_to_grid_threshold=0.8683, avg_axis_margin_score=86.83, max_axis_aligned_ratio=0.037, max_axis_margin_to_grid_threshold=0.863, p95_axis_aligned_ratio=0.037, p95_axis_margin_to_grid_threshold=0.863, min_axis_aligned_ratio=0.0267, min_axis_margin_to_grid_threshold=0.8733, avg_unique_x_count=241.3333, avg_unique_y_count=241.3333
...
- `two_stage_baseline`: avg_line_count=123.3333, avg_axis_aligned_ratio=0.0331, std_axis_aligned_ratio=0.005, avg_axis_margin_to_grid_threshold=0.8669, avg_axis_margin_score=86.69, max_axis_aligned_ratio=0.0455, max_axis_margin_to_grid_threshold=0.8545, p95_axis_aligned_ratio=0.0455, p95_axis_margin_to_grid_threshold=0.8545, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=233.6667, avg_unique_y_count=233.5
