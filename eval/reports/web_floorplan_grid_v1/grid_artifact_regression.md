...
- generated_at: `2026-03-16T23:09:40.995581+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0367, cur=0.0366, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8633, cur=0.8634, delta=0.0001; avg_line_count: prev=113.1667, cur=113.3333, delta=0.1666
...
- `two_stage_baseline`: avg_line_count=113.3333, avg_axis_aligned_ratio=0.0366, std_axis_aligned_ratio=0.0069, avg_axis_margin_to_grid_threshold=0.8634, avg_axis_margin_score=86.34, max_axis_aligned_ratio=0.0488, max_axis_margin_to_grid_threshold=0.8512, p95_axis_aligned_ratio=0.0488, p95_axis_margin_to_grid_threshold=0.8512, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=213.6667, avg_unique_y_count=213.6667
