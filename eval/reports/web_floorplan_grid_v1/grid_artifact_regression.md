...
- generated_at: `2026-03-13T10:10:56.870948+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.15, cur=0.1304, delta=-0.0196; avg_axis_margin_to_grid_threshold: prev=0.75, cur=0.7696, delta=0.0196; avg_line_count: prev=40.0, cur=46.0, delta=6.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.15, cur=0.15, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.75, cur=0.75, delta=0.0; avg_line_count: prev=40.0, cur=40.0, delta=0.0
