...
- generated_at: `2026-03-15T12:09:11.160231+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.25, cur=0.2222, delta=-0.0278; avg_axis_margin_to_grid_threshold: prev=0.65, cur=0.6778, delta=0.0278; avg_line_count: prev=16.0, cur=18.0, delta=2.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.25, cur=0.2222, delta=-0.0278; avg_axis_margin_to_grid_threshold: prev=0.65, cur=0.6778, delta=0.0278; avg_line_count: prev=16.0, cur=18.0, delta=2.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=18.0, avg_axis_aligned_ratio=0.2222, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.6778, avg_axis_margin_score=67.78, max_axis_aligned_ratio=0.2222, max_axis_margin_to_grid_threshold=0.6778, p95_axis_aligned_ratio=0.2222, p95_axis_margin_to_grid_threshold=0.6778, min_axis_aligned_ratio=0.2222, min_axis_margin_to_grid_threshold=0.6778, avg_unique_x_count=24.0, avg_unique_y_count=22.0
...
- `two_stage_baseline`: avg_line_count=18.0, avg_axis_aligned_ratio=0.2222, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.6778, avg_axis_margin_score=67.78, max_axis_aligned_ratio=0.2222, max_axis_margin_to_grid_threshold=0.6778, p95_axis_aligned_ratio=0.2222, p95_axis_margin_to_grid_threshold=0.6778, min_axis_aligned_ratio=0.2222, min_axis_margin_to_grid_threshold=0.6778, avg_unique_x_count=24.0, avg_unique_y_count=23.0
