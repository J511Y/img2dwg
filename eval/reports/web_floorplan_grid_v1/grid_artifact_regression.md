...
- generated_at: `2026-03-08T15:47:23.254110+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.5, cur=0.4615, delta=-0.0385; avg_axis_margin_to_grid_threshold: prev=0.4, cur=0.4385, delta=0.0385; avg_line_count: prev=12.0, cur=13.0, delta=1.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.4615, cur=0.4615, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.4385, cur=0.4385, delta=0.0; avg_line_count: prev=13.0, cur=13.0, delta=0.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=13.0, avg_axis_aligned_ratio=0.4615, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.4385, avg_axis_margin_score=43.85, max_axis_aligned_ratio=0.4615, max_axis_margin_to_grid_threshold=0.4385, p95_axis_aligned_ratio=0.4615, p95_axis_margin_to_grid_threshold=0.4385, min_axis_aligned_ratio=0.4615, min_axis_margin_to_grid_threshold=0.4385, avg_unique_x_count=17.0, avg_unique_y_count=17.0
...
- `two_stage_baseline`: avg_line_count=13.0, avg_axis_aligned_ratio=0.4615, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.4385, avg_axis_margin_score=43.85, max_axis_aligned_ratio=0.4615, max_axis_margin_to_grid_threshold=0.4385, p95_axis_aligned_ratio=0.4615, p95_axis_margin_to_grid_threshold=0.4385, min_axis_aligned_ratio=0.4615, min_axis_margin_to_grid_threshold=0.4385, avg_unique_x_count=17.0, avg_unique_y_count=15.0
