...
- generated_at: `2026-03-17T04:41:11.802490+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0366, cur=0.0361, delta=-0.0005; avg_axis_margin_to_grid_threshold: prev=0.8634, cur=0.8639, delta=0.0005; avg_line_count: prev=110.6667, cur=112.3333, delta=1.6666
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0356, cur=0.0356, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8644, cur=0.8644, delta=0.0; avg_line_count: prev=116.0, cur=116.0, delta=0.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=112.3333, avg_axis_aligned_ratio=0.0361, std_axis_aligned_ratio=0.004, avg_axis_margin_to_grid_threshold=0.8639, avg_axis_margin_score=86.39, max_axis_aligned_ratio=0.0435, max_axis_margin_to_grid_threshold=0.8565, p95_axis_aligned_ratio=0.0435, p95_axis_margin_to_grid_threshold=0.8565, min_axis_aligned_ratio=0.029, min_axis_margin_to_grid_threshold=0.871, avg_unique_x_count=211.6667, avg_unique_y_count=211.6667
...
- `two_stage_baseline`: avg_line_count=116.0, avg_axis_aligned_ratio=0.0356, std_axis_aligned_ratio=0.0062, avg_axis_margin_to_grid_threshold=0.8644, avg_axis_margin_score=86.44, max_axis_aligned_ratio=0.0476, max_axis_margin_to_grid_threshold=0.8524, p95_axis_aligned_ratio=0.0476, p95_axis_margin_to_grid_threshold=0.8524, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=219.0, avg_unique_y_count=219.0
