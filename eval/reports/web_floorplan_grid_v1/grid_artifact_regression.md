...
- generated_at: `2026-03-08T11:47:21.498952+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.75, cur=0.6667, delta=-0.0833; avg_axis_margin_to_grid_threshold: prev=0.15, cur=0.2333, delta=0.0833; avg_line_count: prev=8.0, cur=9.0, delta=1.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.6667, cur=0.6667, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.2333, cur=0.2333, delta=0.0; avg_line_count: prev=9.0, cur=9.0, delta=0.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=9.0, avg_axis_aligned_ratio=0.6667, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.2333, avg_axis_margin_score=23.33, max_axis_aligned_ratio=0.6667, max_axis_margin_to_grid_threshold=0.2333, p95_axis_aligned_ratio=0.6667, p95_axis_margin_to_grid_threshold=0.2333, min_axis_aligned_ratio=0.6667, min_axis_margin_to_grid_threshold=0.2333, avg_unique_x_count=9.0, avg_unique_y_count=9.0
...
- `two_stage_baseline`: avg_line_count=9.0, avg_axis_aligned_ratio=0.6667, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.2333, avg_axis_margin_score=23.33, max_axis_aligned_ratio=0.6667, max_axis_margin_to_grid_threshold=0.2333, p95_axis_aligned_ratio=0.6667, p95_axis_margin_to_grid_threshold=0.2333, min_axis_aligned_ratio=0.6667, min_axis_margin_to_grid_threshold=0.2333, avg_unique_x_count=9.0, avg_unique_y_count=8.0
