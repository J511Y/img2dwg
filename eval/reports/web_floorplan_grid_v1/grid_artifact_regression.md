...
- generated_at: `2026-03-17T05:10:53.784165+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0356, cur=0.0351, delta=-0.0005; avg_axis_margin_to_grid_threshold: prev=0.8644, cur=0.8649, delta=0.0005; avg_line_count: prev=114.0, cur=115.6667, delta=1.6667
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0357, cur=0.0357, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8643, cur=0.8643, delta=0.0; avg_line_count: prev=115.6667, cur=115.6667, delta=0.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=115.6667, avg_axis_aligned_ratio=0.0351, std_axis_aligned_ratio=0.0042, avg_axis_margin_to_grid_threshold=0.8649, avg_axis_margin_score=86.49, max_axis_aligned_ratio=0.0435, max_axis_margin_to_grid_threshold=0.8565, p95_axis_aligned_ratio=0.0435, p95_axis_margin_to_grid_threshold=0.8565, min_axis_aligned_ratio=0.0282, min_axis_margin_to_grid_threshold=0.8718, avg_unique_x_count=218.25, avg_unique_y_count=218.3333
...
- `two_stage_baseline`: avg_line_count=115.6667, avg_axis_aligned_ratio=0.0357, std_axis_aligned_ratio=0.0063, avg_axis_margin_to_grid_threshold=0.8643, avg_axis_margin_score=86.43, max_axis_aligned_ratio=0.0476, max_axis_margin_to_grid_threshold=0.8524, p95_axis_aligned_ratio=0.0476, p95_axis_margin_to_grid_threshold=0.8524, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=218.3333, avg_unique_y_count=218.3333
