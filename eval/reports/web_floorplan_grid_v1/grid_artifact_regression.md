...
- generated_at: `2026-03-08T14:47:39.759012+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.5455, cur=0.5, delta=-0.0455; avg_axis_margin_to_grid_threshold: prev=0.3545, cur=0.4, delta=0.0455; avg_line_count: prev=11.0, cur=12.0, delta=1.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.5, cur=0.5, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.4, cur=0.4, delta=0.0; avg_line_count: prev=12.0, cur=12.0, delta=0.0
