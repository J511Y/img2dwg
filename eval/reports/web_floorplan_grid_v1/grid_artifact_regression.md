...
- generated_at: `2026-03-17T21:39:22.185033+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.034, cur=0.034, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.866, cur=0.866, delta=0.0; avg_line_count: prev=118.8333, cur=118.8333, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0341, cur=0.0338, delta=-0.0003; avg_axis_margin_to_grid_threshold: prev=0.8659, cur=0.8662, delta=0.0003; avg_line_count: prev=120.1667, cur=121.1667, delta=1.0
...
- `two_stage_baseline`: avg_line_count=121.1667, avg_axis_aligned_ratio=0.0338, std_axis_aligned_ratio=0.0053, avg_axis_margin_to_grid_threshold=0.8662, avg_axis_margin_score=86.62, max_axis_aligned_ratio=0.0465, max_axis_margin_to_grid_threshold=0.8535, p95_axis_aligned_ratio=0.0465, p95_axis_margin_to_grid_threshold=0.8535, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=229.3333, avg_unique_y_count=229.3333
