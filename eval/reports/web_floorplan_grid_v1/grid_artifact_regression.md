...
- generated_at: `2026-03-13T18:12:06.537792+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0698, cur=0.0652, delta=-0.0046; avg_axis_margin_to_grid_threshold: prev=0.8302, cur=0.8348, delta=0.0046; avg_line_count: prev=86.0, cur=92.0, delta=6.0
...
- `two_stage_baseline`: avg_line_count=92.0, avg_axis_aligned_ratio=0.0652, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.8348, avg_axis_margin_score=83.48, max_axis_aligned_ratio=0.0652, max_axis_margin_to_grid_threshold=0.8348, p95_axis_aligned_ratio=0.0652, p95_axis_margin_to_grid_threshold=0.8348, min_axis_aligned_ratio=0.0652, min_axis_margin_to_grid_threshold=0.8348, avg_unique_x_count=166.0, avg_unique_y_count=156.0
