...
- generated_at: `2026-03-16T22:39:44.978899+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0368, cur=0.0367, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8632, cur=0.8633, delta=0.0001; avg_line_count: prev=112.8333, cur=113.1667, delta=0.3334
...
- `two_stage_baseline`: avg_line_count=113.1667, avg_axis_aligned_ratio=0.0367, std_axis_aligned_ratio=0.0069, avg_axis_margin_to_grid_threshold=0.8633, avg_axis_margin_score=86.33, max_axis_aligned_ratio=0.0488, max_axis_margin_to_grid_threshold=0.8512, p95_axis_aligned_ratio=0.0488, p95_axis_margin_to_grid_threshold=0.8512, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=213.3333, avg_unique_y_count=213.3333
