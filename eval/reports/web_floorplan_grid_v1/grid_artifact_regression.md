...
- generated_at: `2026-03-14T12:39:22.912066+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0059, cur=0.0058, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8941, cur=0.8942, delta=0.0001; avg_line_count: prev=170.0, cur=172.0, delta=2.0
...
- `two_stage_baseline`: avg_line_count=172.0, avg_axis_aligned_ratio=0.0058, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.8942, avg_axis_margin_score=89.42, max_axis_aligned_ratio=0.0058, max_axis_margin_to_grid_threshold=0.8942, p95_axis_aligned_ratio=0.0058, p95_axis_margin_to_grid_threshold=0.8942, min_axis_aligned_ratio=0.0058, min_axis_margin_to_grid_threshold=0.8942, avg_unique_x_count=331.8333, avg_unique_y_count=322.9167
