...
- generated_at: `2026-03-16T20:09:41.108919+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0371, cur=0.037, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8629, cur=0.863, delta=0.0001; avg_line_count: prev=112.1667, cur=112.3333, delta=0.1666
...
- `two_stage_baseline`: avg_line_count=112.3333, avg_axis_aligned_ratio=0.037, std_axis_aligned_ratio=0.0071, avg_axis_margin_to_grid_threshold=0.863, avg_axis_margin_score=86.3, max_axis_aligned_ratio=0.05, max_axis_margin_to_grid_threshold=0.85, p95_axis_aligned_ratio=0.05, p95_axis_margin_to_grid_threshold=0.85, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=211.6667, avg_unique_y_count=211.6667
