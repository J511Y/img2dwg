...
- generated_at: `2026-03-08T12:47:20.469375+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.6667, cur=0.6, delta=-0.0667; avg_axis_margin_to_grid_threshold: prev=0.2333, cur=0.3, delta=0.0667; avg_line_count: prev=9.0, cur=10.0, delta=1.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.6, cur=0.6, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.3, cur=0.3, delta=0.0; avg_line_count: prev=10.0, cur=10.0, delta=0.0
