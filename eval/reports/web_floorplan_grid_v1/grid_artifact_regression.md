...
- generated_at: `2026-03-16T14:09:44.844762+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0406, cur=0.0396, delta=-0.001; avg_axis_margin_to_grid_threshold: prev=0.8594, cur=0.8604, delta=0.001; avg_line_count: prev=102.5, cur=105.6667, delta=3.1667
...
- `two_stage_baseline`: avg_line_count=105.6667, avg_axis_aligned_ratio=0.0396, std_axis_aligned_ratio=0.008, avg_axis_margin_to_grid_threshold=0.8604, avg_axis_margin_score=86.04, max_axis_aligned_ratio=0.0526, max_axis_margin_to_grid_threshold=0.8474, p95_axis_aligned_ratio=0.0526, p95_axis_margin_to_grid_threshold=0.8474, min_axis_aligned_ratio=0.0267, min_axis_margin_to_grid_threshold=0.8733, avg_unique_x_count=198.3333, avg_unique_y_count=198.3333
