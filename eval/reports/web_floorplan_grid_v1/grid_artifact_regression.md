...
- generated_at: `2026-03-18T00:10:41.256300+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0317, cur=0.0317, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8683, cur=0.8683, delta=0.0; avg_line_count: prev=127.0, cur=127.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0332, cur=0.0331, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8668, cur=0.8669, delta=0.0001; avg_line_count: prev=123.1667, cur=123.3333, delta=0.1666
