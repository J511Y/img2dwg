...
- generated_at: `2026-03-20T12:58:00.957214+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0316, cur=0.0315, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8684, cur=0.8685, delta=0.0001; avg_line_count: prev=129.1667, cur=129.6667, delta=0.5
...
- `two_stage_baseline`: avg_line_count=129.6667, avg_axis_aligned_ratio=0.0315, std_axis_aligned_ratio=0.0047, avg_axis_margin_to_grid_threshold=0.8685, avg_axis_margin_score=86.85, max_axis_aligned_ratio=0.044, max_axis_margin_to_grid_threshold=0.856, p95_axis_aligned_ratio=0.044, p95_axis_margin_to_grid_threshold=0.856, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=246.3333, avg_unique_y_count=246.3333
