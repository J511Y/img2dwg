...
- generated_at: `2026-03-17T10:09:27.878434+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0342, cur=0.0342, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8658, cur=0.8658, delta=0.0; avg_line_count: prev=118.0, cur=118.1667, delta=0.1667
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0344, cur=0.0344, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8656, cur=0.8656, delta=0.0; avg_line_count: prev=119.3333, cur=119.3333, delta=0.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=118.1667, avg_axis_aligned_ratio=0.0342, std_axis_aligned_ratio=0.0033, avg_axis_margin_to_grid_threshold=0.8658, avg_axis_margin_score=86.58, max_axis_aligned_ratio=0.0408, max_axis_margin_to_grid_threshold=0.8592, p95_axis_aligned_ratio=0.0408, p95_axis_margin_to_grid_threshold=0.8592, min_axis_aligned_ratio=0.0282, min_axis_margin_to_grid_threshold=0.8718, avg_unique_x_count=223.3333, avg_unique_y_count=223.3333
...
- `two_stage_baseline`: avg_line_count=119.3333, avg_axis_aligned_ratio=0.0344, std_axis_aligned_ratio=0.0057, avg_axis_margin_to_grid_threshold=0.8656, avg_axis_margin_score=86.56, max_axis_aligned_ratio=0.0476, max_axis_margin_to_grid_threshold=0.8524, p95_axis_aligned_ratio=0.0476, p95_axis_margin_to_grid_threshold=0.8524, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=225.6667, avg_unique_y_count=225.6667
