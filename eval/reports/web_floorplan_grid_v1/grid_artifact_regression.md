...
- generated_at: `2026-03-09T01:17:33.132773+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.25, cur=0.25, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.65, cur=0.65, delta=0.0; avg_line_count: prev=24.0, cur=24.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.2727, cur=0.25, delta=-0.0227; avg_axis_margin_to_grid_threshold: prev=0.6273, cur=0.65, delta=0.0227; avg_line_count: prev=22.0, cur=24.0, delta=2.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=24.0, avg_axis_aligned_ratio=0.25, std_axis_aligned_ratio=0.0, avg_axis_margin_to_grid_threshold=0.65, avg_axis_margin_score=65.0, max_axis_aligned_ratio=0.25, max_axis_margin_to_grid_threshold=0.65, p95_axis_aligned_ratio=0.25, p95_axis_margin_to_grid_threshold=0.65, min_axis_aligned_ratio=0.25, min_axis_margin_to_grid_threshold=0.65, avg_unique_x_count=38.0, avg_unique_y_count=36.0
