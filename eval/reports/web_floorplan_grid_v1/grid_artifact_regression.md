...
- generated_at: `2026-03-18T09:42:34.863371+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0313, cur=0.0311, delta=-0.0002; avg_axis_margin_to_grid_threshold: prev=0.8687, cur=0.8689, delta=0.0002; avg_line_count: prev=129.0, cur=129.8333, delta=0.8333
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0322, cur=0.0322, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8678, cur=0.8678, delta=0.0; avg_line_count: prev=126.5833, cur=126.5833, delta=0.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=129.8333, avg_axis_aligned_ratio=0.0311, std_axis_aligned_ratio=0.0029, avg_axis_margin_to_grid_threshold=0.8689, avg_axis_margin_score=86.89, max_axis_aligned_ratio=0.037, max_axis_margin_to_grid_threshold=0.863, p95_axis_aligned_ratio=0.037, p95_axis_margin_to_grid_threshold=0.863, min_axis_aligned_ratio=0.0258, min_axis_margin_to_grid_threshold=0.8742, avg_unique_x_count=246.6667, avg_unique_y_count=246.6667
...
- `two_stage_baseline`: avg_line_count=126.5833, avg_axis_aligned_ratio=0.0322, std_axis_aligned_ratio=0.0047, avg_axis_margin_to_grid_threshold=0.8678, avg_axis_margin_score=86.78, max_axis_aligned_ratio=0.0444, max_axis_margin_to_grid_threshold=0.8556, p95_axis_aligned_ratio=0.0444, p95_axis_margin_to_grid_threshold=0.8556, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=240.1667, avg_unique_y_count=240.1667
