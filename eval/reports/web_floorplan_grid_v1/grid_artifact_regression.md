...
- generated_at: `2026-03-20T12:30:06.311472+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0316, cur=0.0316, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8684, cur=0.8684, delta=0.0; avg_line_count: prev=129.0, cur=129.1667, delta=0.1667
...
- `two_stage_baseline`: avg_line_count=129.1667, avg_axis_aligned_ratio=0.0316, std_axis_aligned_ratio=0.0047, avg_axis_margin_to_grid_threshold=0.8684, avg_axis_margin_score=86.84, max_axis_aligned_ratio=0.044, max_axis_margin_to_grid_threshold=0.856, p95_axis_aligned_ratio=0.044, p95_axis_margin_to_grid_threshold=0.856, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=245.3333, avg_unique_y_count=245.3333
