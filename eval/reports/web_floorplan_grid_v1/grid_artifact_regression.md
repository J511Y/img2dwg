...
- generated_at: `2026-03-15T20:09:18.096798+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0952, cur=0.0952, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8048, cur=0.8048, delta=0.0; avg_line_count: prev=42.0, cur=42.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0952, cur=0.087, delta=-0.0082; avg_axis_margin_to_grid_threshold: prev=0.8048, cur=0.813, delta=0.0082; avg_line_count: prev=42.0, cur=46.0, delta=4.0
