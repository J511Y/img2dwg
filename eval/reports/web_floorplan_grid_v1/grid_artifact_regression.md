...
- generated_at: `2026-03-20T10:57:42.611004+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0319, cur=0.0318, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8681, cur=0.8682, delta=0.0001; avg_line_count: prev=127.8333, cur=128.0833, delta=0.25
...
- `two_stage_baseline`: avg_line_count=128.0833, avg_axis_aligned_ratio=0.0318, std_axis_aligned_ratio=0.0048, avg_axis_margin_to_grid_threshold=0.8682, avg_axis_margin_score=86.82, max_axis_aligned_ratio=0.0444, max_axis_margin_to_grid_threshold=0.8556, p95_axis_aligned_ratio=0.0444, p95_axis_margin_to_grid_threshold=0.8556, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=243.1667, avg_unique_y_count=243.1667
