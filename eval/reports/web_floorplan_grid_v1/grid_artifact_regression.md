...
- generated_at: `2026-03-08T18:17:27.457289+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.4, cur=0.4, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.5, cur=0.5, delta=0.0; avg_line_count: prev=15.0, cur=15.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.4, cur=0.375, delta=-0.025; avg_axis_margin_to_grid_threshold: prev=0.5, cur=0.525, delta=0.025; avg_line_count: prev=15.0, cur=16.0, delta=1.0
