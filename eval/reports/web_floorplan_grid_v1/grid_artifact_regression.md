...
- generated_at: `2026-03-18T05:41:02.525609+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0326, cur=0.0325, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8674, cur=0.8675, delta=0.0001; avg_line_count: prev=125.1667, cur=125.5, delta=0.3333
...
- `two_stage_baseline`: avg_line_count=125.5, avg_axis_aligned_ratio=0.0325, std_axis_aligned_ratio=0.005, avg_axis_margin_to_grid_threshold=0.8675, avg_axis_margin_score=86.75, max_axis_aligned_ratio=0.0455, max_axis_margin_to_grid_threshold=0.8545, p95_axis_aligned_ratio=0.0455, p95_axis_margin_to_grid_threshold=0.8545, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=238.0, avg_unique_y_count=238.0
