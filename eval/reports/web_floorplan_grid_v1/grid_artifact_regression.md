...
- generated_at: `2026-03-17T23:40:06.353861+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0318, cur=0.0317, delta=-0.0001; avg_axis_margin_to_grid_threshold: prev=0.8682, cur=0.8683, delta=0.0001; avg_line_count: prev=126.8333, cur=127.0, delta=0.1667
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0332, cur=0.0332, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8668, cur=0.8668, delta=0.0; avg_line_count: prev=123.1667, cur=123.1667, delta=0.0

## Strategy diagnostics

- `consensus_qa`: avg_line_count=127.0, avg_axis_aligned_ratio=0.0317, std_axis_aligned_ratio=0.0027, avg_axis_margin_to_grid_threshold=0.8683, avg_axis_margin_score=86.83, max_axis_aligned_ratio=0.037, max_axis_margin_to_grid_threshold=0.863, p95_axis_aligned_ratio=0.037, p95_axis_margin_to_grid_threshold=0.863, min_axis_aligned_ratio=0.0267, min_axis_margin_to_grid_threshold=0.8733, avg_unique_x_count=241.0, avg_unique_y_count=241.0
...
- `two_stage_baseline`: avg_line_count=123.1667, avg_axis_aligned_ratio=0.0332, std_axis_aligned_ratio=0.0052, avg_axis_margin_to_grid_threshold=0.8668, avg_axis_margin_score=86.68, max_axis_aligned_ratio=0.0465, max_axis_margin_to_grid_threshold=0.8535, p95_axis_aligned_ratio=0.0465, p95_axis_margin_to_grid_threshold=0.8535, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=233.3333, avg_unique_y_count=233.1667
