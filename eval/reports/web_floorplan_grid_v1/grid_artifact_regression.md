...
- generated_at: `2026-03-13T17:39:59.439031+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.0698, cur=0.0625, delta=-0.0073; avg_axis_margin_to_grid_threshold: prev=0.8302, cur=0.8375, delta=0.0073; avg_line_count: prev=86.0, cur=96.0, delta=10.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0698, cur=0.0698, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.8302, cur=0.8302, delta=0.0; avg_line_count: prev=86.0, cur=86.0, delta=0.0
