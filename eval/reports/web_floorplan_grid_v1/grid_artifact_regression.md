...
- generated_at: `2026-03-16T14:43:15.511243+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0396, cur=0.0381, delta=-0.0015; avg_axis_margin_to_grid_threshold: prev=0.8604, cur=0.8619, delta=0.0015; avg_line_count: prev=105.6667, cur=110.3333, delta=4.6666
...
- `two_stage_baseline`: avg_line_count=110.3333, avg_axis_aligned_ratio=0.0381, std_axis_aligned_ratio=0.0082, avg_axis_margin_to_grid_threshold=0.8619, avg_axis_margin_score=86.19, max_axis_aligned_ratio=0.0526, max_axis_margin_to_grid_threshold=0.8474, p95_axis_aligned_ratio=0.0526, p95_axis_margin_to_grid_threshold=0.8474, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=207.6667, avg_unique_y_count=207.5833
