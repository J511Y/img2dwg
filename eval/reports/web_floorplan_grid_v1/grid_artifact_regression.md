...
- generated_at: `2026-03-23T11:18:18.843271+00:00`
- total_cases: `36`
- passed_cases: `36`
- failed_cases: `0`
- pass_rate: `1.0`
...
- `consensus_qa`: avg_axis_aligned_ratio: prev=0.031, cur=0.031, delta=0.0; avg_axis_margin_to_grid_threshold: prev=0.869, cur=0.869, delta=0.0; avg_line_count: prev=130.0, cur=130.0, delta=0.0
...
- `two_stage_baseline`: avg_axis_aligned_ratio: prev=0.0316, cur=0.0314, delta=-0.0002; avg_axis_margin_to_grid_threshold: prev=0.8684, cur=0.8686, delta=0.0002; avg_line_count: prev=129.0, cur=129.75, delta=0.75
...
- `two_stage_baseline`: avg_line_count=129.75, avg_axis_aligned_ratio=0.0314, std_axis_aligned_ratio=0.0048, avg_axis_margin_to_grid_threshold=0.8686, avg_axis_margin_score=86.86, max_axis_aligned_ratio=0.0444, max_axis_margin_to_grid_threshold=0.8556, p95_axis_aligned_ratio=0.0444, p95_axis_margin_to_grid_threshold=0.8556, min_axis_aligned_ratio=0.0253, min_axis_margin_to_grid_threshold=0.8747, avg_unique_x_count=246.5, avg_unique_y_count=246.5
