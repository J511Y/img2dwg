...
def test_two_stage_v82_low_skew_grid_relief_lifts_near_square_mid_complexity_layout(
    monkeypatch, tmp_path: Path
) -> None:
    image_path = tmp_path / "low_skew_grid_relief.png"
    ...
    monkeypatch.setattr(
        ...
        lambda _: ImageSignals(width=340, height=330, contrast=0.64, edge_density=0.16),
    )
    ...
    monkeypatch.setattr(
        two_stage,
        "extract_image_signals",
        lambda _: ImageSignals(width=360, height=330, contrast=0.64, edge_density=0.16),
    )
