...
from img2dwg.data.scanner import DataScanner, ProjectData, FileGroup


def test_file_group_is_complete():
...
def test_project_data_has_change_files():
...
def test_project_data_is_incomplete():
...
def test_data_scanner_raises_on_invalid_path():
...
def test_data_scanner_get_statistics():
    """DataScanner의 get_statistics 메서드 테스트."""
    # Arrange
    scanner = DataScanner(Path(__file__).parent.parent / "datas")
